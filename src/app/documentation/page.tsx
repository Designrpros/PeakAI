          ...
          <div className="space-y-12">
            ...
            <section className="py-8" style={{ borderTop: '1px solid var(--stone-border)' }}>
              <div className="flex items-center gap-2 mb-4">
                <BookOpen size={20} style={{ color: 'var(--stone-muted)' }} />
                <h2 className="text-xl font-medium" style={{ color: 'var(--stone-text)' }}>Architecture Overview</h2>
              </div>
            ...
            {/* LLM Providers */}
            <section className="py-8" style={{ borderTop: '1px solid var(--stone-border)' }}>
              <h2 className="text-xl font-medium mb-4" style={{ color: 'var(--stone-text)' }}>LLM Providers</h2>
              <p className="mb-6" style={{ color: 'var(--stone-muted)' }}>
            ...
            {/* Tools */}
            <section className="py-8" style={{ borderTop: '1px solid var(--stone-border)' }}>
              <h2 className="text-xl font-medium mb-4" style={{ color: 'var(--stone-text)' }}>Built-in Tools</h2>
              <p className="mb-6" style={{ color: 'var(--stone-muted)' }}>
            ...
            {/* MCP Integration */}
            <section className="py-8" style={{ borderTop: '1px solid var(--stone-border)' }}>
              <h2 className="text-xl font-medium mb-4" style={{ color: 'var(--stone-text)' }}>Model Context Protocol (MCP)</h2>
              <p className="mb-6" style={{ color: 'var(--stone-muted)' }}>
                PeakAI acts as an MCP Host, connecting to external MCP servers to extend its capabilities. MCP tools are registered with an{' '}
                <code className="px-1 rounded text-sm" style={{ background: 'var(--stone-panel)', color: 'var(--stone-text)' }}>mcp__</code>
                {' '}prefix.
              </p>
            ...
            {/* Google APIs */}
            <section className="py-8" style={{ borderTop: '1px solid var(--stone-border)' }}>
              <h2 className="text-xl font-medium mb-4" style={{ color: 'var(--stone-text)' }}>Google API Setup</h2>
              <p className="mb-6" style={{ color: 'var(--stone-muted)' }}>
            ...
            {/* Adapters */}
            <section className="py-8" style={{ borderTop: '1px solid var(--stone-border)' }}>
              <h2 className="text-xl font-medium mb-4" style={{ color: 'var(--stone-text)' }}>Adapters</h2>
              <p className="mb-6" style={{ color: 'var(--stone-muted)' }}>
            ...
            {/* Permission System */}
            <section className="py-8" style={{ borderTop: '1px solid var(--stone-border)' }}>
              <h2 className="text-xl font-medium mb-4" style={{ color: 'var(--stone-text)' }}>Permission System</h2>
              <p className="mb-6" style={{ color: 'var(--stone-muted)' }}>
            ...
            {/* Getting Started */}
            <section className="py-8" style={{ borderTop: '1px solid var(--stone-border)' }}>
              <h2 className="text-xl font-medium mb-4" style={{ color: 'var(--stone-text)' }}>Quick Start</h2>
